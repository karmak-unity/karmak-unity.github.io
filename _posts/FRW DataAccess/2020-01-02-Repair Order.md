...
icon: "icon-wrench"
type: "data_access" comments: falsedescription: Access all part, labor, and miscellaneous charge detail items on a given repair order
---
...
business system.
 ...
 <!-- SQL VIEW:  **vwSV_SSR_RepairOrderDetails**
...
This information can be found in the repair order application in Fusion.
 ...
 <!-- SQL VIEW:  **vwSV_SSR_RepairOrderHeader**
