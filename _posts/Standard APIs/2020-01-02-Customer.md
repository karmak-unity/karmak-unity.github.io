...
-   When Billing Service Account Number is passed, Allow Billing Service must be
    set to TRUE, otherwise the request will be rejected

Response Details
----------------

-   To perform updates to customer records, use the IDs returned when passing
    the PUT on subsequent requests
...
|CommentID               |                                                                                                                                                                                               |           |    |      |                                                     |
|CommentType             | Description of the customer comment; defaults to first 50 characters of comment unless otherwise entered.                                                                                     | string    |    | 50   |                                                     |
|Comment                 | Customer comment                                                                                                                                                                              | string    |    | 7500 |                                                     |
|CommentBriefDescription | Description of the type of comment associated with the customer; use VTL to select comment type from Comment Type Maintenance                                                                 | string    |    | 10   |                                                     |
