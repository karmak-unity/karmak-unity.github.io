...
| PartID               | 50             | Y            | This is the PartsInventoryDetailID as defined in the business system database for the Part they user is choosing to place on order. The user can call the following API to get the ID from the response to pass in this field. <https://unity.karmak.io/Parts-Search.html> The ID is the PartsInventoryDetailID from the Fusion Database. |
